  ...
  return (
    <div className="-m-[28px] p-6 pb-12 h-[100dvh] font-sans text-slate-300 flex flex-col" style={{ backgroundColor: 'var(--color-bg-app)' }}>
      ...
      <div className="flex justify-center gap-4 mb-6 pt-2 shrink-0">
        <div className="flex items-center gap-2 px-4 h-[30px] rounded-md shadow-lg bg-[#1a212d] border border-red-500/30">
        ...
        <div className="flex items-center gap-2 px-4 h-[30px] rounded-md shadow-lg bg-[#1a212d] border border-blue-500/30">
        ...
        <div className="flex items-center gap-2 px-4 h-[30px] rounded-md shadow-lg bg-[#1a212d] border border-emerald-500/30">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 flex-1 min-h-0">
        ...
        <div className="flex flex-col rounded-xl shadow-lg relative h-full overflow-hidden" style={{ backgroundColor: 'var(--color-bg-surface)', border: '1px solid var(--color-border)' }}>
          <div className="h-[35px] shrink-0 flex items-center justify-center text-[10px] uppercase tracking-widest text-slate-400 font-semibold border-b border-slate-700/50 bg-black/20">
            Customer Complaints
          </div>
        ...
        <div className="flex flex-col rounded-xl shadow-lg relative h-full overflow-hidden" style={{ backgroundColor: 'var(--color-bg-surface)', border: '1px solid var(--color-border)' }}>
          <div className="h-[35px] shrink-0 flex items-center justify-center text-[10px] uppercase tracking-widest text-slate-400 font-semibold border-b border-slate-700/50 relative bg-black/20">
