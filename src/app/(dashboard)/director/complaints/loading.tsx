    ...
    <div className="flex-1 p-6 pb-8 flex flex-col h-full overflow-hidden" style={{ backgroundColor: 'var(--color-bg-app)' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
        <div>
          ...
          <div className="skeleton-pulse" style={{ width: '220px', height: '11px', borderRadius: '4px' }} />
        </div>
      ...
      <div style={{ display: 'flex', gap: '8px', marginBottom: '16px' }}>
        <div className="skeleton-pulse" style={{ flex: 1, maxWidth: '320px', height: '40px', borderRadius: '8px' }} />
        {[1, 2, 3, 4, 5].map(i => (
          <div key={i} className="skeleton-pulse" style={{ width: '80px', height: '40px', borderRadius: '20px' }} />
        ))}
      </div>
